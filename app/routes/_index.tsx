...
export default function Index() {
  ...
  <main className="items-center justify-center">
    ...
    <div key={i} className="card mb-10 md:mb-0">
      ...
      {title}
							...
							<p className="text card-text text-center">
      {text}
    </p>
  </div>
  ))}
  ...
  >
					...
					<p className="text md:pe-10">
						...
						dive into the latest in web design and development. Set to hold at Cyber
						Security Research Center, FUTO, on Nov 20th, 2024. This event
